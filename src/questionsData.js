export default [
  ...
  {
    id: "q8",
    text: "In React, what does the term 'props' stand for? ",
    answers: ["Properties ", "Prototypes ", "Parameters ", "Procedures "],
  },
  {
    id: "q9",
    text: "What is the purpose of the onClick event handler in React?",
    answers: [
